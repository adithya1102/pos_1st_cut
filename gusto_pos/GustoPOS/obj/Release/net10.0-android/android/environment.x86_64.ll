...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 134, ; uint32_t number_of_assemblies_in_apk
	i32 0, ; uint32_t bundled_assembly_name_width
	i32 28, ; uint32_t number_of_dso_cache_entries
	i32 900, ; uint32_t number_of_aot_cache_entries
	i32 107, ; uint32_t number_of_shared_libraries
	i32 u0x020002cf, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06001c95, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001c94, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [900 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.72_name, ; name: libaot-System.IO.Pipes.dll.so
		ptr null; void* handle
	}, ; 31
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x1d59a50d048edd71, ; from name: aot-GustoPOS.so
		i64 u0x2136964a7541527d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GustoPOS.dll.so
		ptr null; void* handle
	}, ; 104
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x2136964a7541527d, ; from name: libaot-GustoPOS.dll.so
		i64 u0x2136964a7541527d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GustoPOS.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x285dbe1cc8ddd2c4, ; from name: aot-GustoPOS
		i64 u0x2136964a7541527d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GustoPOS.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x29eb369600cab10b, ; from name: libaot-GustoPOS
		i64 u0x2136964a7541527d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GustoPOS.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x556651160531b01e, ; from name: GustoPOS.dll.so
		i64 u0x2136964a7541527d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GustoPOS.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x5ce2a39122c03de7, ; from name: GustoPOS.so
		i64 u0x2136964a7541527d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GustoPOS.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x63bff19b16578bb4, ; from name: GustoPOS
		i64 u0x2136964a7541527d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GustoPOS.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xa9f1c59c3406fa43, ; from name: aot-GustoPOS.dll.so
		i64 u0x2136964a7541527d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GustoPOS.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xe3f045bd03c8d80d, ; from name: libaot-GustoPOS.so
		i64 u0x2136964a7541527d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GustoPOS.dll.so
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [25 x i8] c"com.companyname.gustopos\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [23 x i8] c"libaot-GustoPOS.dll.so\00", align 16
...
@.DSOCacheEntry.72_name = private unnamed_addr constant [30 x i8] c"libaot-System.IO.Pipes.dll.so\00", align 16
