...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [134 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 13558152; uint32_t buffer_offset
	}, ; 131: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13729160; uint32_t buffer_offset
	}, ; 132: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2029568, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13751720; uint32_t buffer_offset
	} ; 133: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15781288, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15781288 x i8] zeroinitializer, align 16
