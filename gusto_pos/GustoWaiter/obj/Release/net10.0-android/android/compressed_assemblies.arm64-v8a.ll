...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [132 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 13350280; uint32_t buffer_offset
	}, ; 129: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13521288; uint32_t buffer_offset
	}, ; 130: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2032128, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13543848; uint32_t buffer_offset
	} ; 131: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15575976, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15575976 x i8] zeroinitializer, align 1
